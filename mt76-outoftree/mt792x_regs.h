...
/* For PCIe (MT6639/MT7927): Use MTK's PCIe addresses, not USB addresses */
#define MT_HW_CHIPID			0x88000000  /* CONNAC3X_TOP_HCR */
#define MT_HW_REV			0x88000004  /* CONNAC3X_TOP_FVR (FW version, but used as rev) */
...
#define MT_WFDMA0_PCIE_PDA_CFG		MT_UWFDMA0(0x80c)
#define MT_WFDMA0_PDA_CFG_FWDL_EN	BIT(31)
...
#define MT7927_WFSYS_ON_TOP_WRITE_KEY	(0x5746 << 16)

/* ========== CBTOP_GPIO (0x70005000) ========== */
#define CBTOP_GPIO_BASE				0x70005000
#define CBTOP_GPIO_MODE5_ADDR			(CBTOP_GPIO_BASE + 0x350)	/* 0x70005350 */
#define CBTOP_GPIO_MODE5_MOD_ADDR		(CBTOP_GPIO_BASE + 0x35c)	/* 0x7000535c - Write mode */
#define CBTOP_GPIO_MODE6_ADDR			(CBTOP_GPIO_BASE + 0x360)	/* 0x70005360 */
#define CBTOP_GPIO_MODE6_MOD_ADDR		(CBTOP_GPIO_BASE + 0x36c)	/* 0x7000536c - Write mode */
