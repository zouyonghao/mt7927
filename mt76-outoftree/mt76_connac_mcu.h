...
#define SCAN_FUNC_DBDC_SCAN_DIS	BIT(1)
#define SCAN_FUNC_RANDOM_SN		BIT(4)
#define SCAN_FUNC_SPLIT_SCAN		BIT(5)

#define SCAN_SRC_NORMAL		BIT(0)
#define SCAN_SRC_ROAMING		BIT(1)
#define SCAN_SRC_FW			BIT(2)
#define SCAN_SRC_FENCE		BIT(3)
...
mt76_connac_mcu_gen_dl_mode(struct mt76_dev *dev, u8 feature_set, bool is_wa)
{
	...
	if (is_mt7921(dev) || is_mt7925(dev) || is_mt7927(dev))
